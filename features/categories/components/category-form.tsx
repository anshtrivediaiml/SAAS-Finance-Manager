//This form is only for creating the name of the category
import {z} from 'zod';
...
//This is the form schema for the category name imported for the insertCategorySchema
const FormSchema = insertCategorySchema.pick({
    name:true,
});

//This is the form values for the category name
...
export const CategoryForm=({id,defaultValues,onSubmit,onDelete,disabled}:Props)=>{
    ...
    const form=useForm<FormValues>({
        ...
        defaultValues,
    }); //It only uses name from the category schema so the values are only for the name of the category and we are using the zodResolver to validate the form schema for the category name 
